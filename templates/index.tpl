        ...
        <div class="container">
            ...
            <div class="my-slider">
                ...
                <div class="slider-item">
                    ...
                    <div>
                        {if $product.specific_price == false}
                        <p class="price">{displayPrice price="{$product.price}"}</p>
                        {else}
                        <p class="price"><span>{displayPrice price="{$product.price}"}</span> <s>{displayPrice
                                price="{$product.specific_price.priceWithoutReduction}"}</s></p>
                        {/if}
                    </div>
